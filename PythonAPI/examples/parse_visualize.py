...
# Set the directory containing the .npy file
directory = '/Users/USER/CarlaUE5/PythonAPI/examples/lidar_data/etri/lidar'  # Replace with your directory path
...
ani = FuncAnimation(fig, update, frames=len(data_list), interval=10)
